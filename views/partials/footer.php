    ...
    <div class="footer--grid"> 
        ...
        <div class="footer-col">
            ...
            <nav class="footer-nav">
                <ul>
                    <li><a class="footer-link" href="#">Sua conta</a></li>
                    <li><a class="footer-link" href="#">Entrar</a></li>
                    <li><a class="footer-link" href="#">Criar conta</a></li>
                    <li><a class="footer-link" href="#">Recuperar senha</a></li>
                </ul>
            </nav>
        </div>
        ...
        <div class="footer-col">
            ...
            <nav class="footer-nav">
                <ul>
                    <li><a class="footer-link" href="/controllers/devolucoes.php">Reembolsos</a></li>
                    <li><a class="footer-link" href="/controllers/trabalhe-conosco.php">Trabalhe conosco</a></li>
                    <li><a class="footer-link" href="/controllers/sobre-nos.php">Sobre nós</a></li>
                </ul>
            </nav>
        </div>
