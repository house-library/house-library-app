...
<head>
  ...
  <link rel="stylesheet" href="../views/partials/styles/reset.css">
    ...
    <link rel="stylesheet" href="../views/partials/styles/categoria.css">
</head>
...
<body>
  ...
  <div class="book-item">
   ...
   <div class="book-item">
    <img src="/public/assets/capas-pi/ficcçao cientifica/overdrimecosmico.png" alt="Maravilha">
    <h3>Overdrive cósmico</h3>
    <button class="btn">Adicionar ao carrinho</button>
  </div>

   <div class="book-item">
    <img src="/public/assets/capas-pi/ficcçao cientifica/sonsuniverso.png" alt="Maravilha">
